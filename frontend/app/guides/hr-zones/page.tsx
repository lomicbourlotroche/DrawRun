      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-12">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={z.zone} className="flex items-center gap-4 p-3 bg-background rounded-xl">
                ...
                <code className="text-xs font-mono text-muted">{z.percent}</code>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-red-500 to-pink-500 rounded-3xl p-8 text-white text-center">
          ...
          <button
            ...
            className="px-8 py-3 bg-surface text-danger font-semibold rounded-xl hover:bg-surface transition-colors"
          >
            Calculer mes zones
          </button>
        </div>
