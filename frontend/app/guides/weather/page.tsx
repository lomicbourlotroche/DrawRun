      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-12">
        <div className="text-center">
          ...
          <p className="text-lg text-muted max-w-2xl mx-auto">
            DrawRun récupère les conditions météo au moment de chaque activité et estime leur impact sur votre allure.
            Comprendre ces effets vous aide à contextualiser vos performances.
          </p>
        </div>
        ...
        <div className="bg-surface rounded-3xl border border-surface shadow-sm p-8">
          ...
          <p className="text-muted leading-relaxed">
            Les données météo proviennent de l&apos;API <strong>Open-Meteo</strong> (open-source, gratuite, sans clé
            API). Pour chaque activité, DrawRun récupère les conditions au point GPS de départ et à l&apos;heure de
            début.
          </p>
          <div className="mt-4 p-3 bg-sky-50 rounded-lg border border-sky-100">
            <p className="text-sm text-sky-700">
              <strong>Données collectées :</strong> température, humidité relative, vitesse du vent, précipitations,
              pression atmosphérique, indice UV.
            </p>
          </div>
        </div>
        ...
        <div className="bg-surface rounded-3xl border border-surface shadow-sm p-8">
          ...
          <div className="space-y-3">
            {[
              ...
              {
                range: '10-15°C',
                impact: 'Conditions idéales, aucun impact',
                color: 'text-success',
                bg: 'bg-green-50',
              },
              {
                range: '15-20°C',
                impact: "Léger impact (+1-2% sur l'allure)",
                color: 'text-yellow-600',
                bg: 'bg-yellow-50',
              },
              {
                range: '20-25°C',
                impact: "Impact modéré (+3-5% sur l'allure)",
                color: 'text-orange-600',
                bg: 'bg-orange-50',
              },
              {
                range: '> 25°C',
                impact: "Impact significatif (+5-10% sur l'allure)",
                color: 'text-danger',
                bg: 'bg-red-50',
              },
            ].map((item, i) => (
        ...
        <div className="bg-surface rounded-3xl border border-surface shadow-sm p-8">
          ...
          <p className="text-muted leading-relaxed">
            ...
            DrawRun calcule l&apos;<strong>indice de chaleur</strong> (heat index) pour estimer la température
            ressentie.
          </p>
        </div>
        ...
        <div className="bg-surface rounded-3xl border border-surface shadow-sm p-8">
          ...
          <p className="text-muted leading-relaxed">
            Le vent de face augmente la résistance aérodynamique. À partir de 20 km/h, l&apos;impact sur l&apos;allure
            devient mesurable. DrawRun estime la pénalité en fonction de la vitesse et de la direction du vent par
            rapport à votre parcours.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-primary to-primary rounded-3xl p-8 text-foreground text-center">
          ...
          <p className="text-foreground/80 mb-6">
            Importez vos activités et découvrez l&apos;impact météo sur chaque performance.
          </p>
          <button
