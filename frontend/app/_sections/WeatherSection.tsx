      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className={`transition-all duration-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-primary-500/20 border border-primary-500/30 rounded-full text-sm font-semibold text-primary-400 mb-6">
              ...
              <div className="p-6">
                ...
                <div className="p-3 bg-success-500/10 border border-success-500/30 rounded-xl">
                  <div className="flex items-center gap-2">
                    <AlertTriangle className="w-4 h-4 text-success-400 shrink-0" />
                    <p className="text-sm text-success-300">Conditions idéales — aucun impact sur l&apos;allure</p>
                  </div>
                </div>
              </div>
            </Card>
