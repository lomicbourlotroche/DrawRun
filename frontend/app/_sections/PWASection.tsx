    ...
    <section id="pwa" className="py-20 lg:py-32 bg-gradient-to-b from-white to-neutral-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`mb-12 transition-all duration-700 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="flex flex-col md:flex-row items-center justify-center gap-8">
            ...
            <div className="text-center">
              <div className="w-48 h-32 bg-neutral-900 rounded-xl border-4 border-neutral-700 flex items-center justify-center mx-auto mb-3">
                <Monitor className="w-8 h-8 text-primary-400" />
              </div>
              <p className="text-sm font-medium text-neutral-700">Desktop</p>
              <p className="text-xs text-neutral-500">Chrome, Firefox, Safari</p>
            </div>
            {/* Tablet */}
            <div className="text-center">
              <div className="w-28 h-40 bg-neutral-900 rounded-xl border-4 border-neutral-700 flex items-center justify-center mx-auto mb-3">
                <Smartphone className="w-6 h-6 text-primary-400" />
              </div>
              <p className="text-sm font-medium text-neutral-700">Tablette</p>
              <p className="text-xs text-neutral-500">iPad, Android</p>
            </div>
            {/* Phone */}
            <div className="text-center">
              <div className="w-20 h-36 bg-neutral-900 rounded-xl border-4 border-neutral-700 flex items-center justify-center mx-auto mb-3">
                <Smartphone className="w-5 h-5 text-primary-400" />
              </div>
              <p className="text-sm font-medium text-neutral-700">Mobile</p>
              <p className="text-xs text-neutral-500">iOS, Android</p>
            </div>
          </div>
        </div>
        ...
        <div className={`max-w-2xl mx-auto transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <h3 className="text-center text-lg font-semibold text-neutral-900 mb-6">Installation en 2 étapes</h3>
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-start gap-4 p-4 bg-white border border-neutral-200 rounded-xl">
