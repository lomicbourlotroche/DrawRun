...
export function StrategySlider({ value, onChange }: { value: number; onChange: (_v: number) => void }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <input type="range" min="-1" max="1" step="0.1" value={value} onChange={e => onChange(parseFloat(e.target.value))} className="w-full h-2 rounded-lg appearance-none cursor-pointer accent-primary" />
