          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="hidden md:table-cell text-left py-2 px-2 text-muted" title="Cardiac drift">
                  Dérive
                </th>
              ...
              {splits.map((split: Split) => (
                <tr key={split.km} className="border-b border-border/50 hover:bg-muted/30">
                  ...
                  <td className="hidden md:table-cell py-2 px-2 text-muted text-xs">
                    {split.cardiacDrift !== null && split.cardiacDrift !== undefined
                      ? `+${split.cardiacDrift} bpm`
                      : '-'}
                  </td>
