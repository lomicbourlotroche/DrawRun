      ...
      >
        <div className="space-y-4">
          {twoFAStep === 'verify' && (
            <>
              ...
              <div className="flex gap-3">
                ...
                <Button onClick={handleEnable2FA} isLoading={is2FALoading} className="flex-1">
                  Activer
                </Button>
              </div>
            </>
          ...
          {twoFAStep === 'disable' && (
            <>
              <p className="text-sm text-muted">
                Entrez votre code 2FA pour désactiver l&apos;authentification à deux facteurs.
              </p>
              <Input
                label="Code 2FA"
                type="text"
              ...
              <div className="flex gap-3">
                ...
                <Button variant="danger" onClick={handleDisable2FA} isLoading={is2FALoading} className="flex-1">
                  Désactiver
                </Button>
              </div>
            </>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <Button onClick={handleChangePassword} isLoading={isChanging} className="flex-1">
              Enregistrer
            </Button>
          </div>
        </div>
