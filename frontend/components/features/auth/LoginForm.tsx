  ...
  return (
    <div>
      ...
      <div className="relative">
        {Icon && <Icon className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted" aria-hidden="true" />}
        <input
          id={inputId}
          type={type}
          value={value}
    ...
    <div>
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute right-3 top-1/2 -translate-y-1/2 text-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 rounded"
  ...
  return (
    <div className="hidden lg:flex lg:flex-1 relative overflow-hidden bg-gradient-to-br from-background to-background/80 p-12 flex-col justify-between">
      ...
      <div className="relative z-10">
        ...
        <h2 className="text-3xl font-bold text-white tracking-tight leading-tight mb-3">Dominez vos limites</h2>
    ...
    <div className="min-h-screen w-full flex">
      ...
      <div className="flex-1 lg:max-w-[480px] bg-bg relative">
        ...
        <div className="flex flex-col justify-center min-h-screen px-6 py-12 max-w-sm mx-auto">
          ...
          <form
            onSubmit={
              mode === 'forgot' ? handleForgotPassword : mode === 'reset' ? handleResetPassword : handleLoginRegister
            }
            className="space-y-4"
          >
            {requires2FA && (
