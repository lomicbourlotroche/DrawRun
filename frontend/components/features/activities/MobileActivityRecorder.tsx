            ...
            {showSegmentPicker && (
              <div className="space-y-2">
                ...
                <label className="flex items-center gap-2 text-sm text-foreground mb-3">
                  <input type="checkbox" checked={showSegmentsOnMap} onChange={e => setShowSegmentsOnMap(e.target.checked)} className="rounded bg-surface border-surface" />
      ...
      <div className="px-4 pt-12 pb-3">
        ...
        {activeCoachSession && state !== 'idle' && (
          <div className="mt-3 bg-surface rounded-lg px-3 py-2">
            <p className="text-sm font-medium text-foreground">{activeCoachSession.name}</p>
            {activeCoachSession.targetPace && (
              <p className="text-xs text-muted mt-0.5">Allure cible: {formatPace(60 / (activeCoachSession.targetPace / 60))}</p>
            )}
          </div>
        )}
