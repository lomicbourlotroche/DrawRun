...
describe('Input component', () => {
  ...
  it('generates id using useId when no id or label provided', () => {
    render(<Input />);
    const input = screen.getByRole('textbox');
    expect(input.id).toMatch(/^:r[0-9a-z]+:$/);
  });

  it('sets aria-invalid and aria-describedby for error state', () => {
  ...
  it('sets aria-describedby for hint state', () => {
