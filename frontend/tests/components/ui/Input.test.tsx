...
describe('Input component', () => {
  ...
  it('associates dynamically generated id with label when not provided', () => {
  ...
  it('sets aria-describedby for hints', () => {
    render(<Input hint="Hint message" />);
    const input = screen.getByRole('textbox');
    const hintMsg = screen.getByText('Hint message');

    expect(input).toHaveAttribute('aria-invalid', 'false');
    expect(input.getAttribute('aria-describedby')).toBe(hintMsg.id);
  });
});
