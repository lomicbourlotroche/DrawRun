...
const filesToFix = ['../app/app/coach/CoachContent.tsx', '../app/app/profile/ProfileContent.tsx'];
...
const replacements = [
  ...
  [/bg-neutral-500\/20/g, 'bg-border/20'],
  ...
  [/border-l-neutral-500/g, 'border-l-border'],
...
console.log('Début de la correction des 2 derniers fichiers...\n');
