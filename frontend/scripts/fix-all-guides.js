...
// Liste de tous les fichiers de guides
const guidesDir = '../app/guides';
...
try {
  ...
  console.log(`Erreur lors de la lecture du dossier: ${err.message}`);
}
...
console.log(`Début de la correction des ${filesToFix.length} fichiers de guides...\n`);
